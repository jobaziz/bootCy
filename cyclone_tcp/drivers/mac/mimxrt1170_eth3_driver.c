...
error_t mimxrt1170Eth3Init(NetInterface *interface)
{
   ...
   ENET_QOS->MAC_RXQ_CTRL[0] = ENET_QOS_MAC_RXQ_CTRL_RXQ0EN(1);
...
{
   static uint32_t temp[MIMXRT1170_ETH3_TX_BUFFER_SIZE / 4];
   size_t length;
...
{
   static uint32_t temp[MIMXRT1170_ETH3_RX_BUFFER_SIZE / 4];
   error_t error;
   size_t n;
