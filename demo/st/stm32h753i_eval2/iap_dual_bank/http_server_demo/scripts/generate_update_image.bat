...
image_builder_windows.exe --input ..\iap_dual_bank_http_server_demo_%version%.bin --output ../iap_dual_bank_http_server_demo_%version%.img --enc-algo aes-cbc --enc-key aa3ff7d43cc015682c7dfd00de9379e7 --sign-algo rsa-sha256 --sign-key ../resources/keys/rsa_private_key.pem
